      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            <h3 className="font-serif text-xl font-bold text-primary">Apex Office</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Your trusted guide to office equipment and productivity tools.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Get the latest office equipment reviews and productivity tips delivered to your inbox.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 border-t border-border pt-8">
          <p className="text-xs text-muted-foreground leading-relaxed">
            © {new Date().getFullYear()} Apex Office. All rights reserved.
          </p>
